    ...
    <main className="min-h-screen bg-[#f8f9fc]" style={{ fontFamily: "'DM Sans', 'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-7 space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          <div>
            <p className="section-label mb-1.5">ML Prediction Dashboard · 4 Models Active</p>
            ...
            <div className="card p-5 flex-1">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { step: "2", title: "Run 4 ML Models", desc: "Random Forest, Logistic Regression, Decision Tree & SVM predict in parallel.", color: "bg-violet-500" },
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6">
            ...
            <div className="flex flex-col items-center sm:items-end gap-3">
              ...
              <div className="flex flex-wrap justify-center sm:justify-end gap-1.5">
                {["FastAPI", "Next.js", "Random Forest", "Logistic Reg.", "Decision Tree", "SVM"].map((tech) => (
